        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:pr-8">
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-flex items-center px-4 py-2 bg-blue-500/10 rounded-full text-blue-500 text-sm font-medium ">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <motion.button
                  ...
                  className="bg-orange-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-orange-500/90 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center"
                >
